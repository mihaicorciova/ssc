...
public class DataProviderImplHelper {
    ...
    public static List<DailyData> getListPerDay(Map<String, User> userData, Map<String, Map<String, ShiftData>> shiftData, Set<String> excludedGates, String user, DateTime iniDate, DateTime endDate) {
